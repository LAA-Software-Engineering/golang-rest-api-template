    ...
    "paths": {
        ...
        "/books": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Case-insensitive substring filter on author",
                        "name": "author_like",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "id",
                        "description": "Sort field (id, title, author, created_at, updated_at, owner_id)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
        ...
        "/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Optional refresh token to revoke a single family; omit to logout all sessions",
                        "name": "body",
                        "in": "body",
                        "schema": {
