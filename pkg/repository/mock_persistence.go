...
//
//	mockgen -destination=pkg/repository/mock_persistence.go -package=repository golang-rest-api-template/pkg/repository BookPersistence,UserPersistence
//
...
func (m *MockBookPersistence) List(offset, limit int) ([]models.Book, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBookPersistenceMockRecorder) List(offset, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockBookPersistence)(nil).List), offset, limit)
}
